...
class Checkpointer(object):
    ...
    def resume_or_load_infer(self, path: str, *, resume: bool = True) -> object:
        if path:
            return self.load(os.path.join(self.save_dir, path))
        else:
            return self.load(os.path.join(self.save_dir, 'best_model.pth'))
