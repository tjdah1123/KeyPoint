...
class Color(Enum):
    ...
    nose = (0, 0, 255) # 파란색
    right_eye = (0, 0, 255) # 파란색
    left_eye = (0, 0, 255) # 파란색
    right_ear = (255, 0, 0) # 빨간색
    left_ear = (255, 0, 0) # 빨간색
    mouth_right_end = (255, 255, 0) # 노란색
    mouth_left_end = (255, 255, 0) # 노란색
    mouth_middle_up = (255, 255, 0) # 노란색
    mouth_middle_down = (255, 255, 0) # 노란색
    throax = (0, 255, 255) # 하늘색
    pelvis = (255, 0, 0) # 빨간색
    right_shoulder = (255, 0, 255) # 마젠타(연보라?)
    left_shoulder = (255, 0, 255) # 마젠타(연보라?)
    right_elbow = (255, 0, 255) # 마젠타(연보라?)
    left_elbow = (255, 0, 255) # 마젠타(연보라?)
    right_wrist = (255, 0, 255) # 마젠타(연보라?)
    left_wrist = (255, 0, 255) # 마젠타(연보라?)
    right_hip = (0, 255, 0) # 초록색
    left_hip = (0, 255, 0) # 초록색
    right_knee = (0, 255, 0) # 초록색
    left_knee = (0, 255, 0) # 초록색
    right_ankle = (0, 255, 0) # 초록색
    left_ankle = (0, 255, 0) # 초록색
    ...
    def draw_and_connect_keypoints(self, keypoints):
        ...
        for idx, keypoint in enumerate(keypoints):
            ...
            if prob > _KEYPOINT_THRESHOLD:
                ...
                color = tuple(elem/255 for elem in Color[_KEYPOINTS[idx]].value)
